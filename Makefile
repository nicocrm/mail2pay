...
deploy: build
	...
	scw function deploy \
		...
		--runtime=python312 \
		--env-vars="RESEND_API_KEY=$$RESEND_API_KEY,OPENAI_API_KEY=$$OPENAI_API_KEY,COMPANY_NAME=$$COMPANY_NAME,FROM_ADDRESS=$$FROM_ADDRESS,OPENAI_MODEL=$$OPENAI_MODEL,RESEND_WEBHOOK_SECRET=$$RESEND_WEBHOOK_SECRET"
