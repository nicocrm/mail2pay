...
deploy: build
	...
	scw function deploy \
		...
		--runtime=python312 \
		--env-vars="RESEND_API_KEY=$$RESEND_API_KEY,MISTRAL_API_KEY=$$MISTRAL_API_KEY,FROM_ADDRESS=$$FROM_ADDRESS,LLM_MODEL=$$LLM_MODEL,RESEND_WEBHOOK_SECRET=$$RESEND_WEBHOOK_SECRET,CLERK_SECRET_KEY=$$CLERK_SECRET_KEY"
